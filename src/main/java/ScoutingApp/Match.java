...
public class Match {
    ...
    public Match(int matchNum, int red1, int red2, int red3, int blue1, int blue2, int blue3) {
    ...
    public Match(int matchNum, int red1, int red2, int red3, int red4, int blue1, int blue2, int blue3, int blue4) {
        this.matchNum = matchNum;
        this.red1 = red1;
        this.red2 = red2;
        this.red3 = red3;
    ...
    public Match(int matchNum, int red1, int red2, int blue1, int blue2) {
        this.matchNum = matchNum;
        this.red1 = red1;
        this.red2 = red2;
        this.red3 = -1;
    ...
    public Match(SimpleMatch match) {
